...
//デバッグレイヤーをオンに
	...
	XMFLOAT3 EnemyScale2 = { 3.0f, 3.0f, 3.0f };
		...
		if (sceneNo_ == SceneNo::Game) {
			...
			//ゲーム中
				...
				if (isDead == 1) {
					...
					////武器
					//weaponPosition = { eye.x + 20,eye.y - 10,eye.z + 20 };
